...
// Lwjgl3GLBackend` in `mc1201/common` — the override list is contracts C5. Every new Minecraft
...
tasks.named<JavaCompile>("compileJava") {
    ...
    doLast {
        ...
        if (violations.isNotEmpty()) {
            error("Minecraft or loader imports found in mc-lwjgl3/ - tier 1 is LWJGL and the JDK only:\n" +
