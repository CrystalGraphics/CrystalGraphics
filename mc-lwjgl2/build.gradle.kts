...
//
// JAVA 17, like `platform` and `core` here and `mc1201/common` next door. NOT Java 8 as `mc-shared`
...
// subclasses in `mc1710`/`mc1122` are for.
tasks.named<JavaCompile>("compileJava") {
    ...
    doLast {
        ...
        if (violations.isNotEmpty()) {
            error("Minecraft or loader imports found in mc-lwjgl2/ - tier 1 is LWJGL and the JDK only:\n" +
