package com.crystalgraphics.mc.v1710.hotswap;
...
public class CrystalGraphicsHotswapPlugin {
    ...
    public static final String PLUGIN_PACKAGE = "com.crystalgraphics.mc.v1710.hotswap";
    ...
    public static byte[] reloadClass(byte[] inputClassBytes, ClassLoader classLoader, String className,
        ...
        try {
            ...
            final Class<?> helper = Class
                .forName("com.crystalgraphics.mc.v1710.hotswap.TransformHelper", true, classLoader);
