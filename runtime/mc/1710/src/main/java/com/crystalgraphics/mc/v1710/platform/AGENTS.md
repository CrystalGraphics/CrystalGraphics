...
Composes all six 1.7.10 service adapters into a single bundle. Holds private instances of
...
Sole implementor of `CgReloadService` in the 1.7.10 platform layer. `onReload()` delegates
