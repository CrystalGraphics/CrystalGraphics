 ...
 */
 public class CgShaderImpl implements CgShader {
    ...
    private static volatile Consumer<CgShader> uniformInjectorSystem;

    public static void setUniformInjectorSystem(Consumer<CgShader> system) {
        uniformInjectorSystem = system;
    }
    ...
    private void applyAllBindings() {
        ...
        Consumer<CgShader> sys = uniformInjectorSystem;
        if (sys != null) sys.accept(this);
        bindings.apply(this);
