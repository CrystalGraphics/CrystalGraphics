package com.crystalgraphics.gl.pass;
...
public enum CgClearPolicy {
    ...
    COLOR(CgGL.GL_COLOR_BUFFER_BIT),

    /** Clear only the depth buffer. */
    DEPTH(CgGL.GL_DEPTH_BUFFER_BIT),

    /** Clear both color and depth buffers. */
    COLOR_DEPTH(CgGL.GL_COLOR_BUFFER_BIT | CgGL.GL_DEPTH_BUFFER_BIT),

    /** Clear color, depth, and stencil buffers. */
    ALL(CgGL.GL_COLOR_BUFFER_BIT | CgGL.GL_DEPTH_BUFFER_BIT | CgGL.GL_STENCIL_BUFFER_BIT);
