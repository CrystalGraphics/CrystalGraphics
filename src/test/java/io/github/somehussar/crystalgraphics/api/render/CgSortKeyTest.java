...
public class CgSortKeyTest {
    ...
    public void opaqueKey_geometryBeforeAlphaTest() {
        long geoKey = CgSortKey.buildOpaqueKey(CgRenderQueue.GEOMETRY,   0, 0, 0, 50f, FAR);
        long atKey  = CgSortKey.buildOpaqueKey(CgRenderQueue.ALPHA_TEST, 0, 0, 0, 50f, FAR);
    ...
    public void opaqueKey_backgroundBeforeGeometry() {
        long bgKey  = CgSortKey.buildOpaqueKey(CgRenderQueue.BACKGROUND, 0, 0, 0, 100f, FAR);
        long geoKey = CgSortKey.buildOpaqueKey(CgRenderQueue.GEOMETRY,   0, 0, 0, 100f, FAR);
    ...
    public void opaqueKey_closerDepthSmallerKey_frontToBack() {
        long near = CgSortKey.buildOpaqueKey(CgRenderQueue.GEOMETRY, 0, 0, 0, 10f,  FAR);
        long far  = CgSortKey.buildOpaqueKey(CgRenderQueue.GEOMETRY, 0, 0, 0, 500f, FAR);
    ...
    public void opaqueAlwaysSortsBefore_transparent() {
        long opaque = CgSortKey.buildOpaqueKey(CgRenderQueue.GEOMETRY, 0, 0, 0, 999f, FAR);
    ...
    public void priorityTiebreaks_withinSameQueue() {
        long prio0 = CgSortKey.buildOpaqueKey(CgRenderQueue.GEOMETRY, 0, 0, 0, 50f, FAR);
        long prio1 = CgSortKey.buildOpaqueKey(CgRenderQueue.GEOMETRY, 1, 0, 0, 50f, FAR);
