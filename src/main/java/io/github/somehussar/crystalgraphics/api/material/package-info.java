 ...
 *
 * <p>{@link io.github.somehussar.crystalgraphics.api.material.CgMaterial} is the main entry point:
 * it loads a {@code .shader} file, compiles it, holds property values, and provides
 * {@code bind()} / {@code unbind()} for draw-time use.</p>
 *
 * <p>{@link io.github.somehussar.crystalgraphics.api.vertex.CgVertexFormat#SPATIAL} is the
 * predefined {@link io.github.somehussar.crystalgraphics.api.vertex.CgVertexFormat} constant
 ...
 * <p>{@code CgMaterial}, {@link io.github.somehussar.crystalgraphics.gl.buffer.shader.CgUniformBuffer},
 * and {@link io.github.somehussar.crystalgraphics.gl.buffer.shader.CgShaderBuffer} are
 * caller-owned objects. The caller must call {@code delete()} on each before
 * {@link io.github.somehussar.crystalgraphics.gl.lifecycle.CgGraphicsLifecycle#destroyContext()}.</p>
 */
